...
describe('TasksService', () => {
  ...
  describe('getTaskById', () => {
    it('calls taskRepository.findOne(), then retrieves and returns the task', async () => {
      const mockTask = {
        title: 'Test task',
  ...
  describe('createTask', () => {
    it('calls taskRepository.createTask(), creates and returns the task', async () => {
  ...
  describe('updateTaskStatus', () => {
    it('it updates task status', async () => {
